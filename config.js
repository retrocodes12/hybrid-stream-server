...
export const config = Object.freeze({
  ...
  STREMIO_FAST_PROVIDER_LIMIT: toBoundedInteger(process.env.STREMIO_FAST_PROVIDER_LIMIT, 6, 1, 40),
  STREMIO_FAST_STREAM_LIMIT: toBoundedInteger(process.env.STREMIO_FAST_STREAM_LIMIT, 16, 4, 60),
  STREMIO_FAST_EARLY_RETURN_STREAMS: toBoundedInteger(process.env.STREMIO_FAST_EARLY_RETURN_STREAMS, 3, 3, 60),
  STREMIO_FAST_MIN_COMPLETED_PROVIDERS: toBoundedInteger(process.env.STREMIO_FAST_MIN_COMPLETED_PROVIDERS, 1, 1, 12),
  STREMIO_FAST_MAX_WAIT_MS: toBoundedInteger(process.env.STREMIO_FAST_MAX_WAIT_MS, 18000, 1000, 60000),
  STREMIO_STREAM_OVERALL_TIMEOUT_MS: toBoundedInteger(process.env.STREMIO_STREAM_OVERALL_TIMEOUT_MS, 25000, 5000, 90000),
