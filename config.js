...
export const config = Object.freeze({
  ...
  PROVIDER_GLOBAL_MAX_INFLIGHT: toBoundedInteger(process.env.PROVIDER_GLOBAL_MAX_INFLIGHT, 8, 1, 32),
  ...
  STREMIO_FAST_PROVIDER_LIMIT: toBoundedInteger(process.env.STREMIO_FAST_PROVIDER_LIMIT, 12, 1, 40),
  ...
  STREMIO_EMPTY_RESULT_CACHE_TTL_SECONDS: toPositiveInteger(process.env.STREMIO_EMPTY_RESULT_CACHE_TTL_SECONDS, 900),
  ...
  STREMIO_MAX_INFLIGHT_SEARCHES: toBoundedInteger(process.env.STREMIO_MAX_INFLIGHT_SEARCHES, 32, 4, 500),
  ...
  MEMORY_GUARD_PRESSURE_PERCENT: toBoundedInteger(process.env.MEMORY_GUARD_PRESSURE_PERCENT, 80, 50, 98),
  MEMORY_GUARD_CRITICAL_PERCENT: toBoundedInteger(process.env.MEMORY_GUARD_CRITICAL_PERCENT, 90, 60, 99),
