...
export const config = Object.freeze({
  ...
  PROVIDER_TIMEOUT_SECONDS: toPositiveInteger(process.env.PROVIDER_TIMEOUT_SECONDS, 25),
  ...
  PROVIDER_HOST_MAX_INFLIGHT: toBoundedInteger(process.env.PROVIDER_HOST_MAX_INFLIGHT, 10, 1, 100),
  PROVIDER_MAX_CONCURRENCY: toBoundedInteger(process.env.PROVIDER_MAX_CONCURRENCY, 16, 1, 32),
  PROVIDER_GLOBAL_MAX_INFLIGHT: toBoundedInteger(process.env.PROVIDER_GLOBAL_MAX_INFLIGHT, 24, 1, 128),
  PROVIDER_FETCH_REQUEST_TIMEOUT_MS: toBoundedInteger(process.env.PROVIDER_FETCH_REQUEST_TIMEOUT_MS, 25000, 3000, 60000),
  PROVIDER_RESULT_MEMORY_CACHE_MAX_ENTRIES: toBoundedInteger(process.env.PROVIDER_RESULT_MEMORY_CACHE_MAX_ENTRIES, 5000, 50, 20000),
  PROVIDER_RESULT_MEMORY_CACHE_MAX_MB: toBoundedInteger(process.env.PROVIDER_RESULT_MEMORY_CACHE_MAX_MB, 64, 1, 512),
  ...
  STREMIO_FAST_PROVIDER_CONCURRENCY: toBoundedInteger(process.env.STREMIO_FAST_PROVIDER_CONCURRENCY, 6, 1, 16),
  STREMIO_FAST_PROVIDER_LIMIT: toBoundedInteger(process.env.STREMIO_FAST_PROVIDER_LIMIT, 10, 1, 40),
  ...
  STREMIO_FAST_MAX_WAIT_MS: toBoundedInteger(process.env.STREMIO_FAST_MAX_WAIT_MS, 25000, 1000, 60000),
  STREMIO_STREAM_OVERALL_TIMEOUT_MS: toBoundedInteger(process.env.STREMIO_STREAM_OVERALL_TIMEOUT_MS, 35000, 5000, 90000),
  ...
  STREMIO_RESULT_MEMORY_CACHE_MAX_ENTRIES: toBoundedInteger(process.env.STREMIO_RESULT_MEMORY_CACHE_MAX_ENTRIES, 5000, 50, 20000),
  STREMIO_RESULT_MEMORY_CACHE_MAX_MB: toBoundedInteger(process.env.STREMIO_RESULT_MEMORY_CACHE_MAX_MB, 128, 1, 512),
