...
export const config = Object.freeze({
  ...
  PROVIDER_TIMEOUT_SECONDS: toPositiveInteger(process.env.PROVIDER_TIMEOUT_SECONDS, 15),
  ...
  PROVIDER_FETCH_REQUEST_TIMEOUT_MS: toBoundedInteger(process.env.PROVIDER_FETCH_REQUEST_TIMEOUT_MS, 15000, 3000, 60000),
  ...
  STREMIO_FAST_MAX_WAIT_MS: toBoundedInteger(process.env.STREMIO_FAST_MAX_WAIT_MS, 15000, 1000, 60000),
