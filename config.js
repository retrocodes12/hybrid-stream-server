...
export const config = Object.freeze({
  ...
  PUBLIC_BASE_URL: String(process.env.PUBLIC_BASE_URL || 'https://nebula.work.gd').trim().replace(/\/+$/u, ''),
  ...
  SCRAPLING_SERVICE_TIMEOUT_MS: toBoundedInteger(process.env.SCRAPLING_SERVICE_TIMEOUT_MS, 22000, 3000, 45000),
  ...
  MEMORY_GUARD_RESTART_PERCENT: toBoundedInteger(process.env.MEMORY_GUARD_RESTART_PERCENT, 95, 70, 99),
