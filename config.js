...
export const config = Object.freeze({
  ...
  PROVIDER_MAX_CONCURRENCY: toBoundedInteger(process.env.PROVIDER_MAX_CONCURRENCY, 2, 1, 8),
  PROVIDER_GLOBAL_MAX_INFLIGHT: toBoundedInteger(process.env.PROVIDER_GLOBAL_MAX_INFLIGHT, 2, 1, 32),
  ...
  STREMIO_FAST_PROVIDER_CONCURRENCY: toBoundedInteger(process.env.STREMIO_FAST_PROVIDER_CONCURRENCY, 2, 1, 8),
  ...
  STREMIO_EMPTY_RESULT_CACHE_TTL_SECONDS: toPositiveInteger(process.env.STREMIO_EMPTY_RESULT_CACHE_TTL_SECONDS, 120),
